...
–
- O comando *${prefix}dados* é usado para consultar o tempo que falta para acabar o seu aluguel no grupo. (Para os adms do grupo aonde está alugado!)
–
...
–
- Adicione e remova seus próprios comandos da lista, para somente aqueles que atuam como premium no momento usarem...
- Lembrando que somente o(a) proprietário(a), pode usar estes comandos, beijos!
...
–
A WhiteList serve para permitir aos usuários que estão dentro da lista de usuários permitidos de enviar *links*. Caso o *AntiLinkHard e o AntiLinkGP* esteja ativo no grupo, aonde este tal usuário está! 
- Em breve, este comando poderá se expandir para todos os antis, ainda estamos em fase *BETA* sobre ele, precisamos da avaliação dos usuários para aumentar a grade de antis..
